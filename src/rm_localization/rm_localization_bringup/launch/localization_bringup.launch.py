...
def generate_launch_description():
    ...
    backend_arg = DeclareLaunchArgument(
        'backend', default_value='fast_lio',
    ...
    fast_lio_params_arg = DeclareLaunchArgument(
        'fast_lio_params',
        default_value=PathJoinSubstitution([FindPackageShare('rm_localization_bringup'), 'config', 'fast_lio_mid360.yaml']),
        description='YAML for fast_lio node')
    faster_lio_params_arg = DeclareLaunchArgument(
        'faster_lio_params',
        default_value=PathJoinSubstitution([FindPackageShare('rm_localization_bringup'), 'config', 'faster_lio_ros2.yaml']),
        description='YAML for faster_lio_ros2 node')
    point_lio_params_arg = DeclareLaunchArgument(
        'point_lio_params',
        default_value=PathJoinSubstitution([FindPackageShare('rm_localization_bringup'), 'config', 'point_lio_mid360.yaml']),
    ...
    # For simplicity, use point_lio rviz if present.
