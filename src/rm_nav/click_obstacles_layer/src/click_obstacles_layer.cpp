...
void ClickObstaclesLayer::updateBounds(double /*origin_x*/, double /*origin_y*/, double /*origin_yaw*/,
...
void ClickObstaclesLayer::updateCosts(nav2_costmap_2d::Costmap2D& master_grid,
