...
class ClickObstaclesPanel : public rviz_common::Panel {
  Q_OBJECT
public:
  ClickObstaclesPanel(QWidget* parent = nullptr)
  : rviz_common::Panel(parent) {
    ...
    radius_pub_ = node_->create_publisher<std_msgs::msg::Float32>("/rviz_click_obstacles/set_radius", 10);
    clear_pub_ = node_->create_publisher<std_msgs::msg::Empty>("/rviz_click_obstacles/clear", 10);
    enable_pub_ = node_->create_publisher<std_msgs::msg::Bool>("/rviz_click_obstacles/enable", 10);
